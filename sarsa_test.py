...
agent.load_model('sarsa_model1.pth')
...
df_test.to_csv("test_results/sarsa_result_scen1.csv", index=False)

print("Sarsa testing completed. Results saved to sarsa_test_results.csv.")
